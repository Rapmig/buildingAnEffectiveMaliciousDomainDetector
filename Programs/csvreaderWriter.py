...
ansArray = []
line_count = 0
with open('SMALLmalware_domains4.csv') as csv_file:
    
    with open('SMALLmalware_domainsOUTPUT4.csv', mode='w') as output_file:
        ...
        for row in csv_reader:
            ...
            #print(ans)
            writer.writerow({'Domain Name' : website,'cons' : amountOfConsecutiveCharacters,'active' : activeTimeDomainOutput,'life' : lifeTimeDomainOutput,'averageTTL' : averageTTL})
            #print(ansArray)
            line_count += 1
